...
using WalterApi.Core.Entities.Specification;
...
namespace WalterApi.Core.Services
{
    public class JwtService : IJwtTokenService
    {
        ...
        public JwtService(IConfiguration configuration, IRepository<RefreshToken> tokenRepo, UserManager<AppUser> userManager, TokenValidationParameters tokenValidationParameters)
        {
